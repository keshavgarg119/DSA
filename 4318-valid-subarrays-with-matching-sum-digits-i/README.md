<h2><a href="https://leetcode.com/problems/valid-subarrays-with-matching-sum-digits-i">Valid Subarrays With Matching Sum Digits I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an integer array <code>nums</code> and an integer digit <code>x</code>.</p>
